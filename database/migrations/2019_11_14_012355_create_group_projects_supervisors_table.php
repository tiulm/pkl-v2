...
class CreateGroupProjectsSupervisorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('group_projects_supervisors', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('group_projects_supervisors');
    }
}
